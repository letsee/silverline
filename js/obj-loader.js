...
let mainURL = 'https://intra.letsee.io/3D-model/obj/';
...
function loadModel() {
  return new Promise((resolve) => {
    ...
    const texture = textureLoader.load( mainURL + 'man/UV_Grid_Sm.jpg' );

    let objLoader = new THREE.OBJLoader();
    objLoader.load( mainURL + 'man/male02.obj' , function( obj ) {
